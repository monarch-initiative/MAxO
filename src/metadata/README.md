 ...
 * [maxo.yml](maxo.yml)
     * Determines how your purl.obolibrary.org/obo/maxo/ redirects will be handled
     ...
     * Paste in the contents of [maxo.yml](maxo.yml)
 ...
 * [maxo.md](maxo.md)
     ...
     * Paste in the contents of [maxo.md](maxo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
